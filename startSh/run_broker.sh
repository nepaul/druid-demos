...
JAVA_ARGS="${JAVA_ARGS} -Xmx8g -Xms8g -XX:NewSize=1g -XX:MaxNewSize=1g -XX:MaxDirectMemorySize=5g -XX:+UseConcMarkSweepGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps"
...
JAVA_ARGS="${JAVA_ARGS} -Dcom.sun.management.jmxremote.port=17071 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
