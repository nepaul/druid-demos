[root@localhost ~]# vim /home/letapm/druid-0.8.3/run_historyical.sh
...
JAVA_ARGS="${JAVA_ARGS} -Xmx8g -Xms8g -XX:NewSize=1g -XX:MaxNewSize=1g -XX:MaxDirectMemorySize=10g -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+UseConcMarkSweepGC"
